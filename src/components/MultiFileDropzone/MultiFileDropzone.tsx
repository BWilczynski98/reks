...
const ERROR_MESSAGES = {
  fileTooLarge(maxSize: number) {
    return `Plik jest za duży. Maksymalny rozmiar pliku to ${formatFileSize(maxSize)}.`
  },
  fileInvalidType() {
    return "Niepoprawny typ pliku."
  },
  tooManyFiles(maxFiles: number) {
    return `Możesz dodać maksymalnie ${maxFiles} pliki.`
  },
  fileNotSupported() {
      ...
      <div>
        <div className="flex flex-col gap-2">
          <div>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                ...
                <div className="text-gray-400">Przeciągnij i upuść plik, lub kliknij w to pole, aby dodać zdjęcie</div>
              </div>
            </div>
          ...
          {value?.map(({ file, progress }, i) => (
            <div
              key={i}
              className="flex h-16 w-full max-w-96 flex-col justify-center rounded border border-gray-300 px-4 py-2"
            >
